...
int ActuatorMetaSimple::get_fast_index(fast::ActuatorNodeType type, int turbId, int index, int bladeNum) const{
...
void ActuatorBulkSimple::init_openfast(const ActuatorMetaSimple& actMeta, double naluTimeStep){
...
void ActuatorBulkSimple::init_epsilon(const ActuatorMetaSimple& actMeta){
...
ActuatorBulkSimple::local_range_policy(const ActuatorMeta& actMeta){
...
void ActuatorBulkSimple::interpolate_velocities_to_fast(){
   if (!openFast_.isDryRun()) {
...
void ActuatorBulkSimple::step_fast(){
  if (!openFast_.isDryRun()) {
...
bool ActuatorBulkSimple::fast_is_time_zero(){
...
void ActuatorBulkSimple::output_torque_info(){
