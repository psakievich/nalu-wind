...
template<>
ActSimpleZero::ActuatorFunctor(ActuatorBulkSimple& actBulk) : actBulk_(actBulk){
...
template<>
void
ActSimpleZero::operator()(const int& index) const{
...
template <>
void
ActSimpleUpdatePoints::operator()(const int& index) const
{
...
template<>
ActSimpleAssignVel::ActuatorFunctor(ActuatorBulkSimple& actBulk):actBulk_(actBulk){}
...
template<>
ActSimpleComputeForce::ActuatorFunctor(ActuatorBulkSimple& actBulk):actBulk_(actBulk){
  touch_dual_view(actBulk_.actuatorForce_);
}
...
void ActSimpleSetUpThrustCalc::operator ()(int index) const{
...
ActSimpleComputeThrust::ActSimpleComputeThrust(ActuatorBulkSimple& actBulk, stk::mesh::BulkData& stkBulk):
    actBulk_(actBulk),stkBulk_(stkBulk)
{}

void ActSimpleComputeThrust::operator()(int index) const{
